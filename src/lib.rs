...
const AUDIO_OUTPUT_COMPRESS_NUM_NEGATIVE: i32 = 126;
const AUDIO_OUTPUT_COMPRESS_DEN: i32 = 128;
const AUDIO_OUTPUT_POSITIVE_BIAS: i32 = 67;
...
const AUDIO_OUTPUT_FINAL_NONZERO_BIAS: i32 = 2;
