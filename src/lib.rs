...
const AUDIO_OUTPUT_PREFILTER_GAIN_NUM: i32 = 135;
...
mod tests {
    ...
    fn direct_sound_generates_nonzero_pcm() {
        ...
        assert_eq!(
            ...
            &[998, 998, 1038, 1038, 1027, 1027, 1318, 1318, 970, 970, 1108, 1108, 1179, 1179, 1073, 1073, 1095, 1095]
        );
    }
