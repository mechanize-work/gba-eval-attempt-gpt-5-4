...
const AUDIO_OUTPUT_POST_FILTER_NEGATIVE_BIAS: i32 = -17;
...
mod tests {
    ...
    fn direct_sound_generates_nonzero_pcm() {
        ...
        assert_eq!(
            ...
            &[1020, 1020, 1061, 1061, 1018, 1018, 1312, 1312, 960, 960, 1088, 1088, 1173, 1173, 1061, 1061, 1080, 1080]
        );
    }
